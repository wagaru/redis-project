...
func (_m *PostUsecase) FetchGroupPosts(ctx context.Context, groupName string) ([]*domain.Post, error) {
...
func (_m *PostUsecase) FetchPostByID(ctx context.Context, ID string) (*domain.Post, error) {
...
func (_m *PostUsecase) GroupPost(ctx context.Context, post *domain.Post, groupName string) error {
...
func (_m *PostUsecase) VotePost(ctx context.Context, post *domain.Post, user *domain.User) error {
	ret := _m.Called(ctx, post, user)
